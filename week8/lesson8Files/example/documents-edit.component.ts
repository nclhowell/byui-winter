...
If error does not stop, try using below code for the onSubmit() function
...
Then, try installing the ng2-dnd package again using the --legacy-peer-deps flag:
npm install ng2-dnd --save --legacy-peer-deps
