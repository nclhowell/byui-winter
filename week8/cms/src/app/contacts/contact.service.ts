...
export class ContactService {
 ...
 // Event Emitters
  ...
  updateContact(contact: Contact, newContact: Contact) {
    console.log("Edit Mode True: Original Contact", contact);
    ...
    console.log("Edit Mode True: New Contact derived from form", newContact);
    contact[pos] = newContact;
    console.log("Edit Mode True: New Contact Position", contact[pos]);
    if (pos < 0) {
      return;
    }
